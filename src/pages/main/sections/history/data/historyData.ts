...
export const historyData: Record<string, HistoryEntry[]> = {
  ...
  en: [
    ...
    { period: "2024.10 – 2024.11", activity: "Full-stack Developer – Daon(Initial Startup Team)", description: "Led development of the service MVP." },
    { period: "2024.08 – 2024.09", activity: "Full-stack Developer – Wiro(Initial Startup Team)", description: "end-to-end development of the service MVP." },
    { period: "2024.01",           activity: "Docent",                                  description: "Developed iOS Shortcuts automation features." },
  ...
  ja: [
    ...
    { period: "2024.10 〜 2024.11", activity: "フルスタック開発 – Daon(Initial Startup Team)",          description: "サービスのMVPを総括開発" },
    { period: "2024.08 〜 2024.09", activity: "フルスタック開発 – Wiro(Initial Startup Team)",          description: "サービスのMVPを総括開発" },
    { period: "2024.01",            activity: "Docent .inc (現)",                       description: "iOSショートカットの自動化機能を開発" },
